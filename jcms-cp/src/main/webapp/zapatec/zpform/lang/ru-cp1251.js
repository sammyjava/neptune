// $Id: ru-cp1251.js 8863 2007-11-12 14:18:33Z andrew $
Zapatec.Utils.createNestedHash(Zapatec, ["Langs", "Zapatec.Form", "ru-cp1251"], {
    'initializeError': 'Форма уже инициализирована!',
	'loadingForm': 'загрузка формы',
	'noFormError': "Невозможно найти форму",

	'submitOneError': 'Одна ошибка.',
	'submitManyErrors': 'Общее количество ошибок: %1.',

	'isRequiredError': 'Это поле обязательно к заполнению',
	'maskNotFilledError': 'Значение не соответствует маске %1',
	'noSuchAutoCompleteValueError': 'Нет такого значения',
	'invalidURLError': 'Неправильный URL',
	'invalidEmailError': 'Неправильный email',
	...
	'ajaxSuggestGeneralError': "Не получилось найти значения."
});
