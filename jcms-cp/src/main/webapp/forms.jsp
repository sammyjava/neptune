...
// show Lyris stuff if web.xml contains lyris authentication parameters
boolean showLyris = application.getInitParameter("lyris.username")!=null && application.getInitParameter("lyris.password")!=null;
