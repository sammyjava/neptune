  ...
  */
  ...
  try {
    ...
    if (posted) {
      ...
      // throw exception if captcha not valid (and in use)
      if (form.usecaptcha) Util.validateSimpleCaptcha(session, mpr);
        ...
        <%
          ...
          <%
            ...
            <%
              ...
              %>
                <% if (form.usecaptcha) { %>
                <%@ include file="/WEB-INF/include/simplecaptcha.jhtml" %>
              <% } %>
